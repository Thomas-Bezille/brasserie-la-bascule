 ...
 *   format portrait, fond ardoise, bord déchiré, œillet en tête. Un objet fini
 *   qui porte son propre fond : le cadre n'a plus qu'à le poser, il ne cherche
 *   plus à le rendre lisible.
 ...
 * la couleur d'une bière ne se lit que là-bas, ce composant n'a pas à la
 * connaître. Avec une étiquette, `FicheBiere` choisit toujours le papier, où
 * les six étiquettes ardoise se détachent de la même façon. Sans étiquette, le
 * repli suit le calcul de contraste de `lib/contraste` : trois des sept
 * couleurs n'atteignent pas le seuil de lisibilité sur le gris béton et
 * basculent sur le papier, où elles passent largement. La couleur de Sophie
 * n'est jamais modifiée : c'est le cadre qui s'adapte à la bière.
 *
      ...
      >
        {biere.etiquette ? (
          <Image
            ...
            className="h-auto max-h-[min(74vh,660px)] w-auto"
          />
        ) : (
          <p
